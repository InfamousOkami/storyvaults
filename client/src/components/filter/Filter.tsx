    ...
    <div className="mb-5 pt-5 w-[98%] md:max-w-[600px] mx-auto">
      ...
      >
        ...
        <div className="flex flex-col gap-3 items-center md:flex-row">
          ...
          <input
            className="border w-full md:w-56 py-1 px-1 border-black rounded-md"
            type="text"
            placeholder="Search..."
            name="keywords"
            value={keywords}
          ...
          <div className="flex gap-2">
            ...
            <div className="flex gap-1">
              <label htmlFor="readerAccess">Sort By</label>
              <select
                name="readerAccess"
                id=""
                className=""
        ...
        {/* Submit Button */}
        <button
          className="bg-blue-500 py-2 text-white hover:bg-blue-700 w-56 rounded-lg self-center"
          type="submit"
        >
          Submit
        </button>
