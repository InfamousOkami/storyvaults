...
function EditorStoryRequest({
  ...
  const updateEditorStory = async (status: string) => {
    await axios.patch(
    ...
    <div className="flex w-full gap-1 border-x border-gray-300">
      ...
      <div className="flex w-full justify-between">
        ...
        <div className=" flex h-fit flex-col border-b border-l border-gray-600">
          ...
          <button
            className=" w-full bg-green-500 px-2 py-1  text-white hover:bg-green-600"
            onClick={() => {
              updateEditorStory('Accepted')
            }}
          >
            Accept
          </button>
...
export default EditorStoryRequest
